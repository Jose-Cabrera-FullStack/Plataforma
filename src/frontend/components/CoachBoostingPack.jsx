...
import Iron from '../assets/static/images/elo/Emblem_Iron.png';
import Diamond from '../assets/static/images/elo/Emblem_Diamond.png';
import GrandMaster from '../assets/static/images/elo/Emblem_Grandmaster.png';
import Challenger from '../assets/static/images/elo/Emblem_Challenger.png';
            ...
            <div className="packs__coach__booting__packs ">
                ...
                <div className="pack__coach__booting__packs">
                    ...
                    <figure className="coachs__coach__booting__packs">
                        <img className="coach2__coach__booting__packs" src={Iron} alt=""/>
                    </figure>
                ...
                <div className="pack__coach__booting__packs special__professional__coaching__boosting_pack pack__coach__booting__packs__premium">
                    <h4>COACHING <br/> PROFESIONAL</h4>
                    <div className="promotion__pack__coach__booting__packs promotion__pack__coach__booting__packs__challenger">
                        <p className="paragraph__pack__coach__booting__packs paragraph__pack__coach__booting__packs__challenger">SAVE 25%</p>
                    </div>
                    <figure className="coachs__coach__booting__packs">
                        <img className="coach2__coach__booting__packs coach2__coach__booting__packs__challenger" src={Challenger} alt=""/>
                    </figure>
                ...
                <div className="pack__coach__booting__packs special__avance__coaching__boosting_pack pack__coach__booting__packs__premium">
                    ...
                    <figure className="coachs__coach__booting__packs coachs__coach__booting__packs__grandmaster">
                        <img className="coach2__coach__booting__packs" src={GrandMaster} alt=""/>
                    </figure>
