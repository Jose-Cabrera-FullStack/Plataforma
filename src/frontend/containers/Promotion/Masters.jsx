...
import EmblemIron from '../../assets/static/images/promotion/Emblem_Master.png';
    ...
    <section id="promotion__irons" className="promotion__irons">
        ...
        <div className="promotion__right">
            ...
            <div className="promotion__side">
                ...
                <p className="agenda__time">Antes : ${Math.floor((price.total * (saveMoney)/100) ) + price.total}</p>
...
export default connect(null, mapDispatchToProps)(Masters);